...
const player_level = {"MIN": 1, "MAX":100};
const player_race = {"MIN": 7, "MAX": 21};

const raid_size = { "TENMAN": 10, "GROUP": 5, "TWENTYFIVEMAN": 25};

export {stat_e,class_e,race_e,combat_rating_e,player_class, player_level, player_race,raid_size};
